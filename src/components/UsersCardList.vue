  ...
  <search-field @searchEmpl="searchEmpl" @click="sortByDate"/>
    ...
    <div class="card"
      ...
      <div class="img-container">
        <img :src="'http://91.222.238.181:5000/static/users/' + user.uuid_image" alt="img">
      </div>
  ...
  methods: {
    ...
    async openDialogForChangeData(event) {
      if (parseInt(localStorage.getItem('user_role')) === 2) {
        ...
        const resUsers = await axios.get(`http://91.222.238.181:5000/users/${this.userId}`, {headers: {
